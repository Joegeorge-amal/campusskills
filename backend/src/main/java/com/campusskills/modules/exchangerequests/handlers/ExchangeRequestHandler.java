package com.campusskills.modules.exchangerequests.handlers;
...
public class ExchangeRequestHandler {
    ...
    public ExchangeRequestHandler(ExchangeRequestService service) {
        this.service = service;
    }

    public void createRequest(RoutingContext ctx) {
        try {
            ExchangeRequest request = ctx.body().asJsonObject().mapTo(ExchangeRequest.class);
