    ...
    public static void broadcastNewMessage(Message message, java.util.List<String> participants) {
        try {
            JsonObject eventPayload = new JsonObject()
                    ...
                    .put("messageType", message.getType() != null ? message.getType().name() : "USER")
                    .put("type", message.getType() != null ? message.getType().name() : "USER")
                    .put("sessionId", message.getSessionId())
                    .put("markerId", message.getMarkerId())
                    .put("sessionScheduledStart", message.getSessionScheduledStart())
                    .put("sessionTopic", message.getSessionTopic())
